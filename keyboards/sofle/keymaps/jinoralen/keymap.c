...
[_QWERTY] = LAYOUT( \
  ...
  KC_TAB,   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,     TG(_QWERTY_S), KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RBRC, \
                   KC_LGUI,KC_LALT,KC_LCTRL, KC_LOWER, KC_SPC,     KC_LSFT  , KC_RAISE, KC_RCTRL, KC_RALT, KC_QUOT \
),
...
void matrix_scan_user(void) {
    if (is_alt_tab_active) {
        if (timer_elapsed(alt_tab_timer) > 2250) {
