...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_SYML] = KEYMAP(
	    ...
	    _______ , KC_VOLU , KC_HOME , KC_UP   , KC_END  , KC_PGUP   ,         KC_HOME , _______ , _______ , _______ , _______ , _______ , 
		KC_PSCR , KC_VOLD , KC_LEFT , KC_DOWN , KC_RGHT , KC_PGDOWN ,         KC_END  , _______ , _______ , _______ , _______ , _______ , 
		KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   , KC_F6     ,         KC_F7   , KC_F8   , KC_F9   , KC_F10  , KC_F11  , KC_F12  , 
